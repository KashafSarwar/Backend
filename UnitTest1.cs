...
using QAFastTrack.Core.Entities.Security;
using QAFastTrack.Core.Enums;
using QAFastTrack.Core.SearchCriteria;
using QAFastTrack.Service;
using QAFastTrack.Services;
using System;
using System.Collections.Generic;

namespace QAFastTrack.Tests
{
    public class Tests
    {
        [SetUp]
        ...
        [Test]
        public void Service_Employee_CRUD()
        {
            ...
            //var list = new List<EmployeeDE>();
            ////list = crsSvc.SearchCourse();

            //var emp = new EmployeeDE();
            //emp.Id = 1;
            //emp.Name = "Kashaf";
            //emp.Email = "kashafsarwar23@gmail.com";
            ////ty.DBoperation = DBoperations.Update;
            //emp.DBoperation = DBoperations.Insert;

            //empSvc.ManageEmployee(emp);

        }

        [Test]
        public void Service_User_CRUD()
        {
            ...
            //var list = new List<UserDE>();
            ////list = usrSvc.SearchUser();

            ////var emp = new UserDE();
            ////emp.Id = 2;
            ////emp.Name = "farhat....";
            ////emp.Email = "kashafsarwar23@gmail.com";
            ////// emp.DBoperation = DBoperations.Update;
            ////emp.DBoperation = DBoperations.Insert;
            
            ////usrSvc.ManageUser(emp);


            //#region Search
            //List<UserDE> li = new List<UserDE>();
            //list = usrSvc.SearchUser();
            ...
            #region Delete Previous Task

            var usrList = usrSvc.SearchUser();
            foreach (var usrItem in usrList)
            {
                usrItem.DBoperation = DBoperations.Delete;
                usrSvc.ManageUser(usrItem);
            }
            #endregion
        ...
        [Test]
        public void _Service_VoucherType_Crud()
        {

            VoucherTypeService voucSvc = new VoucherTypeService();

            var list = new List<VoucherTypeDE>();
           // list = voucSvc.SearchVoucherType();

            var vou = new VoucherTypeDE();
            vou.Id = 1;
            vou.Name = "farhat";
            vou.DefaultDrCrFirst = true;
            vou.KeyCode = "abc";
            // emp.DBoperation = DBoperations.Update;
            vou.DBoperation = DBoperations.Insert;

            voucSvc.ManageVoucherType(vou);
